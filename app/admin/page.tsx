...
import { doc, getDoc, getDocs, collection, deleteDoc, addDoc, setDoc, updateDoc, orderBy, query } from "firebase/firestore";
    ...
    <AdminLayout>
      ...
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        {(() => {
          ...
          return (
            <div id="queries" className="mt-4">
              <BentoGrid className="grid-cols-1" enableSpotlight spotlightRadius={800}>
                <BentoCard label={`User Queries (${queries.length})`} enableStars={false}>
